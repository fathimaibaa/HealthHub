...
import { CHAT_API, DOCTOR_API, USER_API } from '../../cccc/Index';
            ...
            {patient.appoinmentStatus === 'Booked' ? (
              <>
                <div className="p-4 bg-gray-50 rounded-lg shadow-inner">
                  ...
                  <button
                    className="bg-purple-500 text-white py-2 px-4 rounded-md shadow hover:bg-purple-800 flex items-center mt-3"
                    onClick={handleChat}
                  >
                ...
                <div className="flex justify-center items-center mt-4 md:col-span-2">
                  {prescription ? (
                    <button
                      className="bg-purple-900 text-white py-2 px-4 rounded-md shadow hover:bg-purple-800 flex items-center"
          ...
          <div className="bg-white p-6 rounded-lg shadow-xl w-full max-w-2xl">
            ...
            <div className="mt-2 space-y-4">
              <div>
                ...
                <input
                  type="date"
                  className="border rounded-lg px-3 py-2 w-full focus:outline-none focus:border-purple-800"
              ...
              <button
                className="text-purple-800 hover:text-purple-600 font-semibold"
